...
useHead({ title: `Paul Bowles's Photography` })
...
<template>
  <div class="">
    <div
      class="h-screen bg-background-light dark:bg-background-dark relative bg-[url('@/assets/imgs/mobile-covers/photography.png')] lg:bg-[url('@/assets/imgs/photography.png')]"
