...
<template>
  <div class="">
    <div class="h-screen bg-background-light dark:bg-background-dark relative flex items-center">
      <div
        class="h-full md:w-2/3 z-10 bg-gradient-to-r from-background-light dark:via-background-dark/80 via-background-light/80 dark:from-background-dark md:from-50% to-transparent flex flex-col justify-center items-start">
