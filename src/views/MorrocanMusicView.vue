...
<template>
  <div class="">
    <div
      ...
      <img src="@/assets/imgs/mobile-covers/Moroccan-music.png"
        class="md:hidden absolute top-0 right-0 w-full h-full object-cover object-right  " />
      <img src="@/assets/imgs/MoroccanMusic.png"
        class="max-md:hidden absolute top-0 right-0 w-full h-full object-cover" />
      <div class="cover__overlay" />
      <div class="h-full md:w-2/3 flex flex-col justify-center items-start relative">
        <div class="p-5 lg:px-16 2xl:px-20">
          <h1 class="text-title font-mono uppercase">Moroccan Music</h1>
