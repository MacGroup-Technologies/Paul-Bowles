...
<template>
  <div class="">
    <div class="px-5 py-20 lg:px-16 2xl:px-20 text-xl lg:text-2xl lg:py-20">
      ...
      >
        <img
          src="@/assets/imgs/Tennessee-Williams.png"
          class="md:w-1/3 h-auto transition-all"
          alt="Tennessee Williams"
        />
      ...
      <div class="text-justify">
        ...
        <p class="mb-10">
          The story itself is a chronicle of startling adventure against a background of the Sahara and Arab-populated regions of the African continent, a portion of the world seldom dealt with by first-rate writers who actually know it. Paul Bowles does know it, and much better, for instance, than it was known by André Gide. He probably knows it better than Albert Camus. For Paul Bowles has been going to Africa, off and on, since about 1930. It thrills him, but for some reason it does not upset his nervous equilibrium. He does not remain in the coastal cities. At frequent intervals he takes journeys into the most mysterious recesses of the desert and mountain country of North Africa, involving not only hardship but peril.
        </p>
        <p class="mb-10">
