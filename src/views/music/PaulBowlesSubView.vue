      ...
      <template v-if="music.items.length !== 0">
        <div class="mt-10 mb-20">
          ...
          <p class="" v-else-if="router.params.title === 'Incidental Music'">
            In 1992, Bowles composed incidental music for Eurypides’s Hippolytus (presented by the American School of Tangier). This is Bowles’s first composition using a synthesizer. Oscar Wilde’s Salomé was followed in 1993, also presented by the American School of Tangier and composed on a synthesizer.
          </p>
        ...
        <div class="">
          ...
          <div
            class="bg-black bg-opacity-10 md:w-1/3 p-5 rounded"
            v-if="!isEmpty(player.item)"
            :key="player.item.id"
          >
            <div class="mb-3 flex items-center justify-between gap-5">
              ...
              <div
                class="w-10 flex items-center justify-center cursor-pointer"
                @click="playMusic()"
              >
                <svg
                  v-if="playState !== 'play'"
