  ...
  <div class="">
    <div class="px-5 py-20 lg:px-16 2xl:px-20 text-xl lg:text-2xl lg:py-20">
      ...
      <div class="mt-10" v-if="route.params.title === 'Leonard Bernstein'">
        <b class="text-black">Handwritten note by Leonard Bernstein to professor Lawrence J. Shifreen in a letter dated
          03/10/77</b>
        <p class="my-6">
      ...
      <div class="mt-10 " v-else-if="route.params.title === 'Irene Herrmann: Paul Bowles, Composer'">
      ...
      <div class="mt-10 " v-else-if="route.params.title === 'Virgil Thompson - On Twelfth Night'">
      ...
      <div class="mt-10 " v-else-if="route.params.title === 'Lincoln Center Tribute'">
      ...
      <div class="mt-10 " v-else-if="route.params.title === 'Rey Rosa - The Return Trip'">
