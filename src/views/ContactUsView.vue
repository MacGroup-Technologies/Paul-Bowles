  ...
  <div class="">
    ...
    <div class="px-5 py-20 lg:px-16 2xl:px-20 text-xl lg:text-2xl lg:py-20 text-center">
      ...
      <el-form
        :model="peter_wright"
        :rules="rules"
        ref="peter_wright_mail"
        class="md:w-1/2 my-10 mx-auto"
        label-position="top"
      >
        <el-form-item label="Name" prop="name">
          <el-input
            v-model="peter_wright.name"
            size="large"
            placeholder="Joh Doe"
          />
        </el-form-item>
